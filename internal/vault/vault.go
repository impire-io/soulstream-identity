...
// first key (../soul-hq/02-DESIGN/soulstream-identity/agent.md D13) before they reach the storage backend
...
const (
	...
	// user JWTs. Scoped signing keys are the recommended shape (../soul-hq/02-DESIGN/soulstream-identity/agent.md D5).
...
// fields are the authorization source (../soul-hq/02-DESIGN/soulstream-identity/nats-surface.md D25):
// for an account signing key, Account is the account it signs for —
// the role's binding (../soul-hq/02-DESIGN/soulstream-identity/auth-callout.md D24, D28 — a role is a
...
// with it (../soul-hq/02-DESIGN/soulstream-identity/agent.md D6 as amended); both empty for user keys.
type Entry struct {
...
// Store is the storage backend seam (../soul-hq/02-DESIGN/soulstream-identity/agent.md D10): it moves
...
// key ("SX…" curve seed — ../soul-hq/02-DESIGN/soulstream-identity/agent.md D13).
...
// open — a mis-supplied seed must not double-seal a vault (../soul-hq/02-DESIGN/soulstream-identity/nats-surface.md).
...
// (../soul-hq/02-DESIGN/soulstream-identity/nats-surface.md D26): no per-user provisioning act exists;
...
// ExportSeed returns the raw secret: THE custody escape (../soul-hq/02-DESIGN/soulstream-identity/agent.md D7), used
